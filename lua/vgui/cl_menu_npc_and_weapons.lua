        ...
        for k, AllNPC in SortedPairsByMemberValue(v, "PrintName") do
            ...
            icon.DoClick = function()
                ...
                if not table.HasValue(items, AllNPC.NameKey.. ":"..chance) then
                    table.insert(items, AllNPC.NameKey.. ":"..chance..":".."standart:reg:reg:reg")
                    npcList:AddLine(AllNPC.NameKey.. ":"..chance..":".."standart:reg:reg:reg")
            ...
            icon.DoRightClick = function()
                ...
                local manual_health = vgui.Create("DTextEntry", Additional_Settings)
                manual_health:SetPos(400, 200)
                manual_health:SetSize(100, 25)
                manual_health:SetText("reg")
                local text_manual_health = vgui.Create("DLabel", Additional_Settings)
                text_manual_health:SetPos(350, 200)
                text_manual_health:SetSize(200, 20)
                text_manual_health:SetText("Health")
                text_manual_health:SetColor(Color(255, 255, 255))

                local manual_model = vgui.Create("DTextEntry", Additional_Settings)
                manual_model:SetPos(400, 230)
                manual_model:SetSize(100, 25)
                manual_model:SetText("reg")
                local text_manual_model = vgui.Create("DLabel", Additional_Settings)
                text_manual_model:SetPos(350, 230)
                text_manual_model:SetSize(200, 20)
                text_manual_model:SetText("Model")
                text_manual_model:SetColor(Color(255, 255, 255))

                local manual_skin = vgui.Create("DTextEntry", Additional_Settings)
                manual_skin:SetPos(400, 260)
                manual_skin:SetSize(100, 25)
                manual_skin:SetText("reg")
                local text_manual_skin = vgui.Create("DLabel", Additional_Settings)
                text_manual_skin:SetPos(350, 260)
                text_manual_skin:SetSize(200, 20)
                text_manual_skin:SetText("Skin")
                text_manual_skin:SetColor(Color(255, 255, 255))
                ...
                SetSettings.DoClick = function()
                    ...
                    local health_NPC = manual_health:GetValue()
                    local model_NPC = manual_model:GetValue()
                    local skin_NPC = manual_skin:GetValue()
                    if not table.HasValue(items, AllNPC.NameKey.. ":"..chance) then
                        if weapon_NPC_manual != "" then
                            table.insert(items, AllNPC.NameKey.. ":"..chance..":"..weapon_NPC_manual..":"..health_NPC..":"..model_NPC..":"..skin_NPC)
                            npcList:AddLine(AllNPC.NameKey.. ":"..chance..":"..weapon_NPC_manual..":"..health_NPC..":"..model_NPC..":"..skin_NPC)
                            WriteItemsFileTR_NPC(ply, items)
                        elseif weapon_player != "standart" and weapon_NPC == "standart" then
                            table.insert(items, AllNPC.NameKey.. ":"..chance..":"..weapon_player..":"..health_NPC..":"..model_NPC..":"..skin_NPC)
                            npcList:AddLine(AllNPC.NameKey.. ":"..chance..":"..weapon_player..":"..health_NPC..":"..model_NPC..":"..skin_NPC)
                            WriteItemsFileTR_NPC(ply, items)
                        elseif weapon_player == "standart" and weapon_NPC != "standart" then
                            table.insert(items, AllNPC.NameKey.. ":"..chance..":"..weapon_NPC..":"..health_NPC..":"..model_NPC..":"..skin_NPC)
                            npcList:AddLine(AllNPC.NameKey.. ":"..chance..":"..weapon_NPC..":"..health_NPC..":"..model_NPC..":"..skin_NPC)
                            WriteItemsFileTR_NPC(ply, items)
                        else
                            table.insert(items, AllNPC.NameKey.. ":"..chance..":"..weapon_NPC..":"..health_NPC..":"..model_NPC..":"..skin_NPC)
                            npcList:AddLine(AllNPC.NameKey.. ":"..chance..":"..weapon_NPC..":"..health_NPC..":"..model_NPC..":"..skin_NPC)
